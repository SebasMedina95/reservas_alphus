...
$recorridos = ControladorRecorridos::ctrMostrarRecorridosActivos();

?>

<!--=====================================
ATRACCIONES DEL HOTEL
======================================-->
...
<div class="recorridoPueblo container-fluid bg-white pb-5" id="pueblo">
	...
	<div class="container">
		...
		<h1 class="pt-5 text-center">ATRACCIONES DEL HOTEL</h1>	
							...
							<li>
								...
								<div class="grid-container pt-4 pb-1 pb-lg-3 px-0 px-lg-5">
									...
									<div class="grid-item">
										...
										<h1 class="mt-2 mb-0 my-lg-2"><?php echo $value["titulo"] ?></h1>
